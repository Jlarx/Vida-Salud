...
* The original package name 'ms-vidasalud-appointments' is invalid and this project uses 'ms_vidasalud_appointments' instead.
...
* [OAuth2 Resource Server](https://docs.spring.io/spring-boot/4.0.8/reference/web/spring-security.html#web.security.oauth2.server)
